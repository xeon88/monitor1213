...
(deffacts initialmap (prior_cell (pos-r 1) (pos-c 1) (type gate)) 
...
(prior_cell (pos-r 2) (pos-c 4) (type border)) 
...
(prior_cell (pos-r 4) (pos-c 2) (type border)) 
(prior_cell (pos-r 4) (pos-c 3) (type border)) 
(prior_cell (pos-r 4) (pos-c 4) (type gate)) 
)
(defrule createworld 
    ?f<-   (create) =>
...
(deftemplate kagent (slot time) (slot step) (slot pos-r) (slot pos-c) 
                    (slot direction))
;	COMPLETATA (VEDI PEZ DROPBOX)
(deftemplate kagent_cell 
	(slot pos-r) 
	(slot pos-c)
	(slot percepted (allowed-values water border gate hill urban rural))
	(slot loitered (allowed-values no other deep-water low-water)(default no))
	(slot utility)
	(slot inform (allowed-values no ok initial-flood severe-flood)(default no))
)
